...
PassiveStats(OUTPUT_XML_FILE, STATS_INTERVAL, ONLY_DATA, VERBOSE)

=s Wifi

Track loss rates, packet tx times for each wireless link.

=d
Expects wireless packets and aggregates information for wireless links.

=h stats
Print information accumulated for each wireless link.
